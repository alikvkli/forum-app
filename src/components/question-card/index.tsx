...
export default function  QuestionCard (){
    return (
        <div  className="bg-[#fff] w-full min-h-full shadow-md flex  rounded-md">
            ...
            <Link  to={`/soru-cevap/1`} className="w-full flex flex-col gap-2 py-4 px-4">
                ...
                <div className="mt-auto flex items-center gap-2 border-t-default pt-2.5">
                    ...
                    <Link className="text-primary text-sm" to="/profil/ali_kvkli">@ali_kvkli</Link>
                </div>
